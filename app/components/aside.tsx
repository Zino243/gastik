...
export default function Aside({ isOpen, setAsideOpen, subscriptions, onLogout }: AsideProps){
        ...
        function isVisible(){
            if (isOpen) {
                ...
                subscriptions.map((subscription) => {
                    console.log("[log]", subscription.Service)
                })
            ...
            <div className={`
                ...
                ">
                    ...
                    {subscriptions.map((subscription, id) => (
                        <div key={id}
                        className={`flex flex-row justify-between p-2 py-4 m-2 rounded-sm [&>svg]:w-8 transition-all duration-300 bg-secondary
                        ...
                        `}>
                            ...
                            <span>{subscription.Service?.name || `$${subscription.price}`}</span>
                ...
                <div className="mt-auto">
                    ...
                    *:rounded-sm
                    ...
                    gap-2
                    ">
                        <div className="flex flex-row p-2 py-4 *:cursor-pointer" onClick={onLogout}>
