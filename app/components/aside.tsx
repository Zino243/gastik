        ...
        <>
            <div className={`
                ...
                ">
                    <div className="
                        ...
                        *:pb-4
                        gap-2
                        ">
                        <h1 className="font-bold text-3xl text-center pt-8 pb-4">Subscripciones</h1>
                        <button 
                    ...
                    <div className="h-0.5 bg-chart-2 mx-4 mb-6"></div>
                ...
                <div className="mt-auto ">
                    <div className="h-0.5 bg-chart-2 mx-4"></div>
