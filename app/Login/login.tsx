    ...
    const renderContent = changeLogin ? (
        <div className="flex flex-col w-full min-h-screen items-center justify-center">
            <div className="flex flex-col w-full justify-center bg-card py-25 max-w-2xl p-8 rounded-xl">
                ...
                [&>input]:mx-8
                flex flex-col">
                    <input type="text" name="signIn_name" id="signIn_name" placeholder="example@gmail.com"/>
                    ...
                    <button type="submit" className="bg-primary p-4 px-8 text-xl rounded-full mx-8 mb-12"
                    onClick={() => {signButton()}}>Sign In</button>
                </form>
                    ...
                    <div className="flex justify-center ">
                        <p className="text-secondary px-2">Dont have an account?</p><a href="/dashboard" className="text-primary">Create new one</a>
                    </div>
            </div>
        </div>
    ) : (
        <div className="flex flex-col w-full min-h-screen items-center justify-center">
            <div className="flex flex-col w-full justify-center bg-card py-25 max-w-2xl p-8 rounded-xl">
                ...
                [&>input]:mx-8
                flex flex-col">
                    <input type="text" name="signUp_name" id="signUp_name" placeholder="example_doe" />
                    <input type="text" name="signUp_mail" id="signUp_mail" placeholder="example@gmail.com"/>
                    <input name="signUp_password1" id="signUp_password1" type="password" placeholder="•••••••••"/>
                    <input name="signUp_password2" id="signUp_password2" type="password" placeholder="•••••••••"/>
                    ...
                    <button
                    type="submit" className="bg-primary p-4 px-8 text-xl rounded-full mx-8 mb-12"
                    onClick={() => {signButton()}}>Sign Up</button>
                </form>
                    <div className="flex justify-center ">
                        <p className="text-secondary px-2">Dont have an account?</p><a href="/dashboard" className="text-primary">Create new one</a>
                    </div>
